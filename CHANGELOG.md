# v99.0.0 — Honky-Tonk Rebuild

- Rebuilt visual system from Nora's supplied CSS.
- Removed illustrated neon drawings and replaced them with responsive typographic sign panels.
- Added consistent professional line icons to every mobile menu.
- Fixed EST. 2025 • BIRMINGHAM header visibility.
- Standardised dark red/black styling across homepage, booking, footer and legal pages.
- Retained newsletter API and welcome-email workflow.
...
- Installed one consistent menu across all public pages, including About, Meet Nora, Why Boot Scootin?, My Story and Contact.
- Connected the newsletter form to the existing D1 subscriber API without opening the visitor’s email app.
- Updated booking and arrival sections to the dark honky-tonk visual system.
- Improved mobile header spacing and established-brand visibility.
